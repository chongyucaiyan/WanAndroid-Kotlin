 ...
 * 项目列表页的ViewModel
 */
class ProjectListViewModel(private val mDataManager: DataManager) : BaseViewModel() {
    ...
    private fun getAllData() {
        ...
        addDisposable(mDataManager.getProjectArticleListData(1, mId)
    ...
    private fun getMoreArticleListData() {
        addDisposable(mDataManager.getProjectArticleListData(mPageNum, mId)
                .compose(RxUtils.applySchedulers())
